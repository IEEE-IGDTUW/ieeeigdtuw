...
const Footer = () => {
    ...
    return (
        <div
            id="contact-us"
            className="relative overflow-hidden" // Ensure no content spills out
            data-aos="fade-up"
            data-aos-offset="200"
        >
            {/* Gradient Divider */}
            <div
                className="w-full h-[2px] bg-gradient-to-r from-[#7042f8] to-[#00c6ff] shadow-lg mb-5"
                data-aos="fade-down"
                data-aos-duration="1500"
            ></div>

            {/* Footer Main Section */}
            <div className="w-full bg-[#03001417] text-gray-300 py-8 backdrop-blur-md shadow-inner shadow-[#2A0E61]/50">
                <div className="container mx-auto px-6 lg:px-20 flex flex-col items-center justify-center text-center">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-6 text-sm w-full">
                        ...
                        <div data-aos="fade-right">
                            ...
                            <p className="mb-2">
                                Indira Gandhi Delhi Technical University for Women, New Church Rd,
                                Opp. St James Church, Kashmere Gate, Delhi 110006
                            </p>
                        </div>
                        ...
                        <div data-aos="fade-up">
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <a href="#about" className="hover:text-[#7042f8] transition-colors">
                                        About Us
                                    </a>
                                </li>
                                <li>
                                    <a href="#events" className="hover:text-[#7042f8] transition-colors">
                                        Events
                                    </a>
                                </li>
                                <li>
                                    <a href="#team" className="hover:text-[#7042f8] transition-colors">
                                        Team
                                    </a>
                                </li>
                            </ul>
                        ...
                        {/* Column 3: Follow Us and Contact */}
